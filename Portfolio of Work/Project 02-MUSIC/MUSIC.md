...
- [02 ARDUINO PIANO](#02-ARDUINO-PIANO)
    - [COMPONENT REQUIREMENTS](#COMPONENT-REQUIREMENTS)
    - [WIRING](#WIRING)
    - [CODING](#CODING)
    - [PRODUCTION PROCESS](#PRODUCTION-PROCESS)
    - [DEMO VIDEO](#DEMO-VIDEO)
- [03 ARDUINO DRUM](#03-ARDUINO-DRUM)
    - [COMPONENT REQUIREMENTS](#COMPONENT-REQUIREMENTS)
    - [WIRING](#WIRING)
    - [CODING](#CODING)
    - [PRODUCTION PROCESS](#PRODUCTION-PROCESS)
    - [DEMO VIDEO](#DEMO-VIDEO)
- [04 MUSIC VISUALIZATION](#04-MUSIC-VISUALIZATION)
    - [COMPONENT REQUIREMENTS AND WIRING](#COMPONENT-REQUIREMENTS-AND-WIRING)
    - [CODING](#CODING)
    - [DEMO VIDEO](#DEMO-VIDEO)
- [05 CONCLUSION AND SUMMARY](#05-CONCLUSION-AND-SUMMARY)
